...
def L21_CMNMF_Train(train_parameter_cell, matrix_cell_train, initial_matrix_cell):
    ...
    [L, G_out, P1_out, P2_out] = L21_CMNMF_LF(max_ites, A1, A2, G, P1, P2, M, Y1, Y2, alpha, beta, gamma, miu, rou)
